...
# NYC dog bite data from Data.gov (https://catalog.data.gov/dataset/dohmh-dog-bite-data)
...
# Convert DateOfBite to date format and find the range
range <- range(mdy(data$DateOfBite), na.rm = TRUE)
